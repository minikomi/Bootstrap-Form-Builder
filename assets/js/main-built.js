...
define('text!templates/popover/popover-hidden.html',[],function () { return '<input type="hidden" value="" name="<%- name %>" id="<%- name %>" value="<%- value %>" />\n';});
...
define('models/my-form-snippets-wrapper',[
