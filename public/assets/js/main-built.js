...
define('text!templates/snippet/button.html',[],function () { return '<!-- Button -->\n<label class="control-label"><%= label %></label>\n<div class="controls">\n  <button class=\'btn <%= _.find(buttontype, function(o){return o.selected})["value"] %>\'><%= buttonlabel %></button>\n</div>\n';});

define('text!templates/snippet/buttondouble.html',[],function () { return '<!-- Button (Double) -->\n<label class="control-label"><%= label %></label>\n<div class="controls">\n  <button class=\'btn <%= _.find(button1type, function(o){return o.selected})["value"] %>\'><%= button1label %></button>\n  <button class=\'btn <%= _.find(button2type, function(o){return o.selected})["value"] %>\'><%= button2label %></button>\n</div>\n';});
...
define('text!templates/snippet/multiplecheckboxes.html',[],function () { return '<!-- Multiple Checkboxes (inline) -->\n<label class="control-label"><%= label %></label>\n<div class="controls">\n  <% _.each(checkboxes, function(checkbox){ %><label class="checkbox">\n    <input type="checkbox" value="<%= checkbox %>">\n    <%= checkbox %>\n  </label><% }); %>\n</div>\n';});

define('text!templates/snippet/multiplecheckboxesinline.html',[],function () { return '<!-- Multiple Checkboxes -->\n<label class="control-label"><%= label %></label>\n<div class="controls"><% _.each(checkboxes, function(checkbox){ %>\n  <label class="checkbox inline">\n    <input type="checkbox" value="<%= checkbox %>">\n    <%= checkbox %>\n  </label><% }); %>\n</div>\n';});

define('text!templates/snippet/multipleradios.html',[],function () { return '<!-- Multiple Radios -->\n<label class="control-label"><%= label %></label>\n<div class="controls">\n  <% _.each(radios, function(radio, i){ %><label class="radio">\n    <input type="radio" value="<%= radio %>"  <% if (i < 1) { %> checked="checked" <% } %>>\n    <%= radio %>\n  </label><% }); %>\n</div>\n';});
...
define('text!templates/app/renderform.html',[],function () { return '<form class="form-horizontal">\n<fieldset>\n\n<%= text %>\n</fieldset>\n</form>\n';});
...
define('views/my-form',[
  ...
  return Backbone.View.extend({
    ...
    , render: function(){
      ...
      $("#render").text(that.renderForm({text: _.map(this.collection.renderAllClean(), function(e){return e.html()}).join("\n")}));
